import boto3  # Consegue a comunicação com qualquer serviço da AWS
...
class S3Client:
    ...
    def __init__(self):
        # Valida se tem todas as variáveis de ambientes com os requisitos necessários
        self._envs = {
        ...
        # Verifica as variáveis e quebra o código se alguma está faltando
